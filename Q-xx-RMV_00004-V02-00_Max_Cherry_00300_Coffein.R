...
dt$para$model.name <- gsub( "-00", "-01", dt$para$model.name)
...
file.copy("D:/OneDrive - Dausch Technologies GmbH/Dokumentation/QM/06_FO_Formblaetter/FO-223_V01_1_Validierungstabelle_Mastermodell.xltx"
